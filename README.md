...
[LeoKeidranさんのプレイ](https://www.youtube.com/watch?v=i2sAbJZzFCg)の右下のカメラに写っている姿勢が参考になる。こうすることで手の負担も抑えられるので長時間のプレイが可能になる。
...
ヒールゼリーは効果範囲に多少のランダムが絡む上にガイドポイント上を高速で移動させてしまうとゼリーの塗り漏れが発生してしまうので注意する。

切開パターン自体はそんなに多く無いので早すぎず遅すぎない速度を掴むことが重要になる。

ゼリーがうまく乗らなかった時でもメスで切開は可能だが、判定はかなりシビア。
...
骨の破片を元の位置に戻すシーンでは、骨片の角度はそこまで重要ではなく、**色の変わっている設置エリア内でピンセットを離したかどうか**が重要になる。このエリア外でピンセットを話してしまうと例え角度が一致していて設置場所に近かったとしてもミスになってしまう。
...
注意点の1つ目として、**Cの火傷からの出血は吸い上げてはいけない**。この出血を吸い上げてしまうとBの火傷に人口膜を乗せようとしてCに乗ってしまう事故が発生する。出血が残っていればCの火傷の判定がなくなるのでBの火傷へ人口膜を確実に乗せることができる。

![image](/images/6-5-1c.jpg)

注意点の2つ目として、Dの火傷は右上・右下・左下の枠のいずれかから出血していたら吸い上げなければEの火傷へ人口膜を乗せることができない。↓画像の通りにDの火傷の左上から出血した場合だけ吸い上げること無くEの火傷へ培養皮膚を乗せることができる。
...
切開前は左端の隣接した2箇所に散弾が埋まっている。この2箇所は出血頻度が早いので、散弾の摘出が完了したらこの2箇所以外のところからドレーンで一気に出血を吸い上げて人口膜をかぶせていく。
...
五人目、初期内出血は5箇所で、さらに1箇所でも縫合すると追加で裂傷と内出血3個が現れる。逆に言えば初期内出血を全て切り出しただけの状態であれば安全なので、バイタルを回復する余裕がある。

また、内出血の追加だけでなく右上部での裂傷生成も発生する。処置手順としては初期内出血を全て切り出した後に回復し、左上の切り出した内出血の縫合を行う。

その後追加の内出血も切り出しておき、少しずつ出血の吸い出しと縫合を行って再出血を防ぎながら
