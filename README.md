...
プレイヤーの操作速度と精度がそのままタイムとして反映されるので自分の中では**このゲームのRTAはパズルゲームだと思っています。**
...
その為にも正確且つ可能な限り素早くリモコンを操作する必要がある。
...
- スコア画面が終わった後に(+)ボタンからエピソードリストへ抜けてもクリア扱いになる。
...
6. 破裂するもののみ、切り出さないで放置すると裂傷と血溜まりを発生させた上にバイタルを大きく減らす（10～15程度）
