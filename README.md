...
[Wii本体の内部チップによってロード時間が変わるので、判明分をまとめてみた](https://iid01.com/wii_load_time/)

初期生産の白WiiとGC2-DMSチップが乗った黒Wiiでざっくり算出したところ
...
ロード時間差が発生するシーンは以下の通り。

|シーン|差|
|-|-:|
|メッセージスキップ|立ち絵切り替え量に比例|
|手術開始までの暗転|約0.2秒|
|術野切り替え||
|メニューからエピソード一覧へ移動|約0.8～0.9秒|

ロード時間を見分ける目安としては手術終了後にメニューからエピソード一覧に戻る際の暗転時間を見るのが最もわかりやすい。
...
**ここで難易度をHARDの変更することでオニュクスの潜伏時間を短縮することができる。**
...
あとは9番と10番を注射器耐久力を気にせず処理することができる。これでおよそ2秒程の短縮が可能。
